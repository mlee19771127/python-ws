...
# 环境变量
UUID = os.environ.get('UUID', '17ff8504-3d01-4097-8576-e115e8b0a24b')   # 节点UUID
...
DOMAIN = os.environ.get('DOMAIN', 'dcdeploy.275610.xyz')                # 项目分配的域名或反代后的域名,不包含https://前缀,例如: domain.xxx.com
SUB_PATH = os.environ.get('SUB_PATH', 'sub')         # 节点订阅token
NAME = os.environ.get('NAME', 'dcdeploy')                    # 节点名称
